(function () {
    var stage,
        ...
        imageManifest = [
            ...
            // 签到门
            {
                src: 'middle/wall_shadow.png',
                id: 'middle_wall_shadow',
                container: 'middle',
                position: { x: 1312, y: 1031 }
            },
            ...
            // 表彰门
            {
                src: 'middle/wall_shadow2.png',
                id: 'middle_wall_shadow_2',
                container: 'middle',
                position: { x: 4812, y: 1033 }
            },
            {
                src: 'middle/commendation_bg.png',
                id: 'middle_commendation_bg',
                container: 'middle',
                position: { x: 4855, y: 268 }
            },
            {
                src: 'middle/door_left.png',
                id: 'middle_door_left_2',
                container: 'middle',
                position: { x: 4868, y: 594 }
            },
            { src: 'middle/wall_left.png', id: 'middle_wall_left_2', container: 'middle', position: { x: 4828, y: 0 } },

            // 抽奖-装饰
            {
                src: 'middle/lottery_decorate.png',
                id: 'middle_lottery_decorate',
                container: 'middle',
            ...
            // 钞票-装饰
            {
                src: 'middle/bill_decorate1.png',
                id: 'middle_bill_decorate1',
                container: 'middle',
                position: { x: 8600, y: 110 }
            },
            {
                src: 'middle/bill_decorate2.png',
                id: 'middle_bill_decorate2',
                container: 'middle',
                position: { x: 8700, y: 110 }
            },
            ...
            // 领奖-装饰
            {
                src: 'middle/prize_decorate.png',
                id: 'middle_prize_decorate',
                container: 'middle',
                position: { x: 9500, y: 100 }
            },
            ...
            {
                src: 'middle/door_left.png',
                id: 'middle_door_left_3',
                container: 'middle',
                position: { x: 10568, y: 594 }
            },
            {
                src: 'middle/wall_left.png',
                id: 'middle_wall_left_3',
                container: 'middle',
                position: { x: 10528, y: 0 }
            },
            ...
            {
                src: 'role/stand_eyeopen_right.png',
                id: 'role_stand_eyeopen_right',
                container: 'role',
                position: { x: center, y: 738 }
            },
            {
                src: 'role/stand_eyeclose_right.png',
                id: 'role_stand_eyeclose_right',
                hidden: true,
                container: 'role',
                position: { x: center, y: 738 }
            },
            {
                src: 'role/stand_eyeopen_left.png',
                id: 'role_stand_eyeopen_left',
                hidden: true,
                container: 'role',
                position: { x: center + 10, y: 738 }
            },
            {
                src: 'role/stand_eyeclose_left.png',
                id: 'role_stand_eyeclose_left',
                hidden: true,
                container: 'role',
                position: { x: center + 10, y: 738 }
            },
            ...
            {
                src: 'top/lighting_right.png',
                id: 'top_lighting_right',
                container: 'top',
                position: { x: 6370, y: 245 }
            },
    ...
    function drawRoleText() {
        ...
        RoleTextRect.y = 680;
        RoleTextRect.graphics.clear().beginStroke('#ddd').beginFill('#FFFFFF').drawRect(
            -10,
            -10,
            roleText.getMeasuredWidth() + 20,
            50
        );
    ...
    function bindEvents() {
        ...
        run_left.addEventListener('touchstart', function (e) {
            ...
            run_direction = 'left';
            if (imageDisplayObjects['role_stand_eyeopen_right']) {
                imageDisplayObjects['role_stand_eyeopen_right'].visible = false;
            }
            if (imageDisplayObjects['role_stand_eyeopen_left']) {
            ...
            if (role_axle) {
                ...
                createjs.Tween.get(role_axle, { loop: -1, reversed: run_direction !== 'right' }).to(
                    { rotation: 360 },
                    1000
                );
            }
    ...
    function handleTick(event) {
        ...
        if (tip_show) {
            ...
            if (!event.paused || tip_timeout - tip_init_timeout > 6000) {
                hideMask();
            }
        }
        ...
        if (eye_status === 'open' && eye_timeout > 2000) { //闭眼
            eye_status = 'close';
            eye_timeout = 0;
            if (run_direction === 'right' && imageDisplayObjects['role_stand_eyeopen_right']) {
                imageDisplayObjects['role_stand_eyeopen_right'].visible = false;
                imageDisplayObjects['role_stand_eyeclose_right'].visible = true;
            } else if (run_direction === 'left' && imageDisplayObjects['role_stand_eyeopen_left']) {
                imageDisplayObjects['role_stand_eyeopen_left'].visible = false;
    ...
    function timeDown(id, endDateStr) {
        ...
        //输出到页面
        document.getElementById(id).innerHTML = days * 24 + hours + ' <span>h</span>' + (minutes > 9 ? minutes : '0' + minutes) + '<span>min</span> ' + (seconds > 9 ? seconds : '0' + seconds) + '<span>sec</span>';
        //延迟一秒执行自己
        setTimeout(function () {
    ...
    (function () {
        ...
        initContainer();
        preloadImages();
        // timeDown('timeDown', '2019/01/15 14:30:00');
    })()
})()
